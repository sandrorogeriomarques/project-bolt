...
process.env.VITE_BASEROW_API_URL = process.env.VITE_BASEROW_API_URL || 'https://api.baserow.io/api';
process.env.VITE_BASEROW_TOKEN = process.env.VITE_BASEROW_TOKEN || '0lsB6U6zcpKt8W4f9pydlsvJnibOASeI';
process.env.VITE_BASEROW_MATRIX_CACHE_TABLE_ID = process.env.VITE_BASEROW_MATRIX_CACHE_TABLE_ID || '400157';
process.env.VITE_GOOGLE_MAPS_API_KEY = process.env.VITE_GOOGLE_MAPS_API_KEY || 'AIzaSyDKabwnDraJmiX2e6gMn_BdVOYCF6TSdAo';
...
// Rotas para cache da Matrix API
app.use('/api/distance-matrix', matrixCacheRoutes);
